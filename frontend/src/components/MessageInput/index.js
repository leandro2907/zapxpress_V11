	...
	const [signMessage, setSignMessage] = useLocalStorage("signOption", true);
	    ...
	    const fetchChannelType = async () => {
	      try {
	        ...
	        console.log("Dados recebidos do ticket:", data); // Exibe todo o objeto recebido
	        console.log("Tipo do canal (whatsapp?.type):", data.whatsapp?.type); // Exibe apenas o campo específico
	        
	        setChannelType(data.whatsapp?.type);
	        
	      } catch (err) {
	        console.error("Erro ao buscar o tipo de canal:", err); // Exibe o erro no console
	        toastError(err);
	      }
	    };
